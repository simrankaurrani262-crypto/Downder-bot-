...
class YouTubeDownloader:
    ...
    def _get_ydl_opts(self, quality: str, download_id: str, progress_hook: Callable = None) -> Dict[str, Any]:
        ...
        if quality == "audio":
            ...
            # Fallback chain: combined format -> DASH streams -> any format -> absolute best
            # This ensures downloads work for regular videos, Shorts, and edge cases
            quality_map = {
                "144": "best[height<=144]/bestvideo[height<=144]+bestaudio/best[height<=144]/best",
                "240": "best[height<=240]/bestvideo[height<=240]+bestaudio/best[height<=240]/best",
                "360": "best[height<=360]/bestvideo[height<=360]+bestaudio/best[height<=360]/best",
                "480": "best[height<=480]/bestvideo[height<=480]+bestaudio/best[height<=480]/best",
                "720": "best[height<=720]/bestvideo[height<=720]+bestaudio/best[height<=720]/best",
                "1080": "best[height<=1080]/bestvideo[height<=1080]+bestaudio/best[height<=1080]/best",
                "1440": "best[height<=1440]/bestvideo[height<=1440]+bestaudio/best[height<=1440]/best",
                "2160": "best[height<=2160]/bestvideo[height<=2160]+bestaudio/best[height<=2160]/best",
                "best": "bestvideo+bestaudio/best",
            }
            format_spec = quality_map.get(quality, "best[height<=720]/bestvideo[height<=720]+bestaudio/best[height<=720]/best")
            postprocessors = [{
